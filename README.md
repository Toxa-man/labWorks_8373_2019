# Весенний курс по дисциплине "Программирование" 2019
...
- Внутри директории студента должен находиться файл fio.txt, единственной строкой в котором является ФамилияИО студента записанные кириллицей
